...
Read `PROJECT_STATUS.md`, `README.md`, and `backend/docs/{TARGET_BUNDLES,TARGET_INFERENCE,INTERVENTION_DELIVERY,RESEARCH_INTEGRATION}.md` for operational details. Read `reports/INF-04_TO_INF-12_IMPLEMENTATION.md` for dated validation evidence. Treat the mental-model atlas and original infrastructure plan as design context where they exceed the current source.
