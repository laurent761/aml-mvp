...
Research runs group API-controlled or managed sessions; each research reset creates
a new episode. The existing navigation also shows research sessions, generation
